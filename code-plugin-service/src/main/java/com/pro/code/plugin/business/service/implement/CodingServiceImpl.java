package com.pro.code.plugin.business.service.implement;
...
import com.pro.code.plugin.business.service.ICodingService;
...
@org.springframework.stereotype.Service("com.pro.code.plugin.business.CodingService")
...
public class CodingServiceImpl implements ICodingService {
  ...
  private IVirtualColumnsPersistent irtualColumnsPersistent;
  ...
  public void extract(java.lang.String dtId) throws CodePluginException {
    ...
    try {
      ...
      Collection<VirtualColumns> delVirtualColumnsSource = irtualColumnsPersistent.queryVirtualColumns(virtualColumnsSourceQuery);
      if (ToolUtil.isNotEmpty(delVirtualColumnsSource)) {
        irtualColumnsPersistent.batchRemoveVirtualColumns(delVirtualColumnsSource);
      }
      VirtualColumnsQuery virtualColumnsTargetQuery = new VirtualColumnsQuery();
      virtualColumnsTargetQuery.setTargetDtId(dt.getDtId());
      Collection<VirtualColumns> delVirtualColumnsTarget = irtualColumnsPersistent.queryVirtualColumns(virtualColumnsTargetQuery);
      if (ToolUtil.isNotEmpty(delVirtualColumnsTarget)) {
        irtualColumnsPersistent.batchRemoveVirtualColumns(delVirtualColumnsTarget);
      }
      // 删除表相关的查询数据
          ...
          if (ToolUtil.isNotNullStr(primaryKey)) {
            for (Columns column : saveColumns) {
              if (!primaryKey.equals(column.getColumnName())) {
                if ("java.lang.String".equals(SqlTools.getJavaDataTypeFromDtDataTypeStr(column.getDataType()))) {
                  if (isFirst) {
                    isFirst = false;
  ...
  public Config getConfig(java.lang.String dtId) throws CodePluginException {
    ...
    try {
      ...
      config.setVoFilePath(ConfigTools.getVoFilePathStrFromConfig(dt.getProPath(), dt.getProAllName(), dt.getInitialCaseEntityName()));
      config.setVueEntityFilePath(ConfigTools.getVueEntityFilePathStrFromConfig(dt.getProPath(), dt.getProAllName(), dt.getInitialLowercaseEntityName()));
      config.setVueQueryFilePath(ConfigTools.getVueQueryFilePathStrFromConfig(dt.getProPath(), dt.getProAllName(), dt.getInitialLowercaseEntityName()));
      config.setVueVoFilePath(ConfigTools.getVueVoFilePathStrFromConfig(dt.getProPath(), dt.getProAllName(), dt.getInitialLowercaseEntityName()));
      config.setVueServiceFilePath(ConfigTools.getVueServiceFilePathStrFromConfig(dt.getProPath(), dt.getProAllName(), dt.getInitialLowercaseEntityName()));
      config.setVueStoreFilePath(ConfigTools.getVueStoreFilePathStrFromConfig(dt.getProPath(), dt.getProAllName(), dt.getInitialLowercaseEntityName()));
      config.setVueListFilePath(ConfigTools.getVueListFilePathStrFromConfig(dt.getProPath(), dt.getProAllName(), dt.getInitialLowercaseEntityName()));
      config.setVueListCssFilePath(ConfigTools.getVueListCssFilePathStrFromConfig(dt.getProPath(), dt.getProAllName(), dt.getInitialLowercaseEntityName()));
      config.setVueEditFilePath(ConfigTools.getVueEditFilePathStrFromConfig(dt.getProPath(), dt.getProAllName(), dt.getInitialLowercaseEntityName()));
  ...
  public void codingJdbcEntity(java.lang.String dtId, Config config) throws CodePluginException {
    ...
    try {
      ...
      entityStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/entity/jdbc/1.txt"), configMap));
  ...
  public void codingIPersistent(java.lang.String dtId, Config config) throws CodePluginException {
    ...
    try {
      ...
      configMap.put("VOPackageName", ConfigTools.getVOPackageNameStrFromConfig(dt.getProAllName()));
      configMap.put("proName", ConfigTools.getInitialCaseOrInitialLowercaseHumpFromStr(dt.getProAllName(), true));
      configMap.put("dtName", dt.getDtName());
      configMap.put("initialCaseEntityName", dt.getInitialCaseEntityName());
  ...
  public void codingController(java.lang.String dtId, Config config) throws CodePluginException {
    ...
    try {
      ...
      configMap.put("VOPackageName", ConfigTools.getVOPackageNameStrFromConfig(dt.getProAllName()));
      configMap.put("proName", ConfigTools.getInitialCaseOrInitialLowercaseHumpFromStr(dt.getProAllName(), true));
      configMap.put("initialLowercaseProName", ConfigTools.getInitialCaseOrInitialLowercaseHumpFromStr(dt.getProAllName(), false));
      configMap.put("initialCaseEntityName", dt.getInitialCaseEntityName());
      configMap.put("initialLowercaseEntityName", dt.getInitialLowercaseEntityName());
      PkQuery pkQuery = new PkQuery();
      pkQuery.setDtId(dt.getDtId());
...
//      System.out.println(ss);
      ...
      StrTools.getFileFromContentStrAndPath(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/git/1.txt"), new LinkedHashMap<String, String>()), proPath + ".gitignore");
      ...
      StrTools.getFileFromContentStrAndPath(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/git/1.txt"), new LinkedHashMap<String, String>()), proPath + "entity-jdbc/.gitignore");
      ...
      StrTools.getFileFromContentStrAndPath(name, proPath + "entity-jdbc/src/main/java/com/pro/" + ConfigTools.getBusinessPathStrFromConfig(dt.getProAllName()) + "entity/README.md");
      ...
      StrTools.getFileFromContentStrAndPath(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/git/1.txt"), new LinkedHashMap<String, String>()), proPath + "interface/.gitignore");
      ...
      StrTools.getFileFromContentStrAndPath(name, proPath + "interface/src/main/java/com/pro/" + ConfigTools.getBusinessPathStrFromConfig(dt.getProAllName()) + "exception/README.md");
      StrTools.getFileFromContentStrAndPath(name, proPath + "interface/src/main/java/com/pro/" + ConfigTools.getBusinessPathStrFromConfig(dt.getProAllName()) + "persistent/README.md");
      StrTools.getFileFromContentStrAndPath(name, proPath + "interface/src/main/java/com/pro/" + ConfigTools.getBusinessPathStrFromConfig(dt.getProAllName()) + "service/README.md");
      StrTools.getFileFromContentStrAndPath(name, proPath + "interface/src/main/java/com/pro/" + ConfigTools.getBusinessPathStrFromConfig(dt.getProAllName()) + "query/README.md");
      StrTools.getFileFromContentStrAndPath(name, proPath + "interface/src/main/java/com/pro/" + ConfigTools.getBusinessPathStrFromConfig(dt.getProAllName()) + "vo/README.md");
      ...
      StrTools.getFileFromContentStrAndPath(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/git/1.txt"), new LinkedHashMap<String, String>()), proPath + "persistent-jdbc/.gitignore");
      ...
      StrTools.getFileFromContentStrAndPath(name, proPath + "persistent-jdbc/src/main/java/com/pro/" + ConfigTools.getBusinessPathStrFromConfig(dt.getProAllName()) + "persistent/implement/README.md");
      ...
      StrTools.getFileFromContentStrAndPath(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/git/1.txt"), new LinkedHashMap<String, String>()), proPath + "service/.gitignore");
      ...
      StrTools.getFileFromContentStrAndPath(name, proPath + "service/src/main/java/com/pro/" + ConfigTools.getBusinessPathStrFromConfig(dt.getProAllName()) + "service/implement/README.md");
      ...
      StrTools.getFileFromContentStrAndPath(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/git/1.txt"), new LinkedHashMap<String, String>()), proPath + "rest/.gitignore");
      ...
      StrTools.getFileFromContentStrAndPath(name, proPath + "rest/src/main/java/com/pro/" + ConfigTools.getBusinessPathStrFromConfig(dt.getProAllName()) + "rest/README.md");
      ...
      StrTools.getFileFromContentStrAndPath(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/git/1.txt"), new LinkedHashMap<String, String>()), proPath + "jdbc-rest/.gitignore");
    } catch (CodePluginException e) {
      if (log.isErrorEnabled()) {
        log.error(e);
      }
  ...
  public void codingVo(java.lang.String dtId, Config config) throws CodePluginException {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingService.codingVo ");
      log.debug("parameter dtId is : " + dtId);
      log.debug("parameter config is : " + config);
    }
    try {
      ...
      configMap.put("dtNameAnnotation", dt.getDtNameAnnotation());
      configMap.put("initialCaseEntityName", dt.getInitialCaseEntityName());
      voStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vo/1.txt"), configMap)).append("\n");
      if (ToolUtil.isNotEmpty(columnsSet)) {
        for (Columns eachColumns : columnsSet) {
          LinkedHashMap<String, String> columnConfigMap = new LinkedHashMap<String, String>();
          columnConfigMap.putAll(configMap);
          ...
          columnConfigMap.put("initialLowercaseColumnName", eachColumns.getInitialLowercaseColumnName());
          columnConfigMap.put("columnNameAnnotation", eachColumns.getColumnNameAnnotation());
          voStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vo/2.txt"), columnConfigMap)).append("\n");
        }
      }
      if (ToolUtil.isNotEmpty(columnsSet)) {
        for (Columns eachColumns : columnsSet) {
          ...
          columnConfigMap.put("initialLowercaseColumnName", eachColumns.getInitialLowercaseColumnName());
          columnConfigMap.put("columnNameAnnotation", eachColumns.getColumnNameAnnotation());
          voStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vo/3.txt"), columnConfigMap)).append("\n");
        }
      }
      voStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vo/4.txt"), configMap));
      StrTools.getFileFromContentStrAndPath(voStr.toString(), config.getVoFilePath());
    } catch (CodePluginException e) {
      if (log.isErrorEnabled()) {
        log.error(e);
      }
  ...
  @Override
  public void codingVueEntity(String dtId, Config config) throws CodePluginException {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingService.codingVueEntity ");
      log.debug("parameter dtId is : " + dtId);
      log.debug("parameter config is : " + config);
    }
    try {
      ...
      configMap.putAll(ConfigTools.configMap);
      configMap.put("initialCaseEntityName", dt.getInitialCaseEntityName());
      vueEntityStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/entity/1.txt"), configMap));
      if (ToolUtil.isNotEmpty(columnsSet)) {
        for (Columns eachColumns : columnsSet) {
          LinkedHashMap<String, String> columnConfigMap = new LinkedHashMap<String, String>();
          columnConfigMap.putAll(configMap);
          columnConfigMap.put("initialLowercaseColumnName", eachColumns.getInitialLowercaseColumnName());
          vueEntityStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/entity/2.txt"), columnConfigMap));
        }
      }
      vueEntityStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/entity/3.txt"), configMap));
      StrTools.getFileFromContentStrAndPath(vueEntityStr.toString(), config.getVueEntityFilePath());
    } catch (CodePluginException e) {
      if (log.isErrorEnabled()) {
        log.error(e);
      }
  ...
  @Override
  public void codingVueQuery(String dtId, Config config) throws CodePluginException {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingService.codingVueQuery ");
      log.debug("parameter dtId is : " + dtId);
      log.debug("parameter config is : " + config);
    }
    try {
      ...
      configMap.putAll(ConfigTools.configMap);
      configMap.put("initialCaseEntityName", dt.getInitialCaseEntityName());
      vueQueryStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/query/1.txt"), configMap));
      if (ToolUtil.isNotEmpty(columnsSet)) {
        for (Columns eachColumns : columnsSet) {
          LinkedHashMap<String, String> columnConfigMap = new LinkedHashMap<String, String>();
          columnConfigMap.putAll(configMap);
          columnConfigMap.put("initialLowercaseColumnName", eachColumns.getInitialLowercaseColumnName());
          vueQueryStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/query/2.txt"), columnConfigMap));
        }
      }
      if (ToolUtil.isNotEmpty(querySet)) {
        for (Query eachQuery : querySet) {
      ...
      vueQueryStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/query/3.txt"), configMap));
      StrTools.getFileFromContentStrAndPath(vueQueryStr.toString(), config.getVueQueryFilePath());
    } catch (CodePluginException e) {
      if (log.isErrorEnabled()) {
        log.error(e);
      }
  ...
  @Override
  public void codingVueVo(String dtId, Config config) throws CodePluginException {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingService.codingVueVo ");
      log.debug("parameter dtId is : " + dtId);
      log.debug("parameter config is : " + config);
    }
    try {
      ...
      configMap.putAll(ConfigTools.configMap);
      configMap.put("initialCaseEntityName", dt.getInitialCaseEntityName());
      vueVoStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/vo/1.txt"), configMap));
      if (ToolUtil.isNotEmpty(columnsSet)) {
        for (Columns eachColumns : columnsSet) {
          LinkedHashMap<String, String> columnConfigMap = new LinkedHashMap<String, String>();
          columnConfigMap.putAll(configMap);
          columnConfigMap.put("initialLowercaseColumnName", eachColumns.getInitialLowercaseColumnName());
          vueVoStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/vo/2.txt"), columnConfigMap));
        }
      }
      vueVoStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/vo/3.txt"), configMap));
      StrTools.getFileFromContentStrAndPath(vueVoStr.toString(), config.getVueVoFilePath());
    } catch (CodePluginException e) {
      if (log.isErrorEnabled()) {
        log.error(e);
      }
  ...
  @Override
  public void codingVueService(String dtId, Config config) throws CodePluginException {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingService.codingVueService ");
      log.debug("parameter dtId is : " + dtId);
      log.debug("parameter config is : " + config);
    }
    try {
      ...
      configMap.put("controllerUrl", ConfigTools.getControllerUrlStrFromConfig(dt.getProAllName()));
      configMap.put("initialLowercaseEntityName", dt.getInitialLowercaseEntityName());
      vueServiceStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/service/1.txt"), configMap));
      StrTools.getFileFromContentStrAndPath(vueServiceStr.toString(), config.getVueServiceFilePath());
    } catch (CodePluginException e) {
      if (log.isErrorEnabled()) {
        log.error(e);
      }
  ...
  @Override
  public void codingVueStore(String dtId, Config config) throws CodePluginException {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingService.codingVueStore ");
      log.debug("parameter dtId is : " + dtId);
      log.debug("parameter config is : " + config);
    }
    try {
      ...
      configMap.put("initialCaseEntityName", dt.getInitialCaseEntityName());
      configMap.put("initialLowercaseEntityName", dt.getInitialLowercaseEntityName());
      vueStoreStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/store/1.txt"), configMap));
      StrTools.getFileFromContentStrAndPath(vueStoreStr.toString(), config.getVueStoreFilePath());
    } catch (CodePluginException e) {
      if (log.isErrorEnabled()) {
        log.error(e);
      }
  ...
  @Override
  public void codingVueList(String dtId, Config config) throws CodePluginException {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingService.codingVueList ");
      log.debug("parameter dtId is : " + dtId);
      log.debug("parameter config is : " + config);
    }
    try {
      ...
      StringBuilder vueListStr = new StringBuilder();
      LinkedHashMap<String, String> configMap = new LinkedHashMap<String, String>();
      Dt dt = dtPersistent.getDtByPk(dtId);
      ColumnsQuery columnsQuery = new ColumnsQuery();
      columnsQuery.setDtId(dt.getDtId());
      ...
      vueListStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/list/1.txt"), configMap));
      if (ToolUtil.isNotEmpty(columnsSet)) {
        for (Columns eachColumns : columnsSet) {
          if (ToolUtil.isNotNullStr(primaryKey) && primaryKey.equals(eachColumns.getColumnsId())) {
            continue;
          ...
          String dataType = SqlTools.getAngularDataTypeFromDtDataTypeStr(eachColumns.getDataType());
          if ("string".equals(dataType)) {
            vueListStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/list/2.txt"), columnConfigMap));
          } else if ("number".equals(dataType)) {
            vueListStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/list/3.txt"), columnConfigMap));
          }
        }
      }
      vueListStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/list/4.txt"), configMap));
      if (ToolUtil.isNotEmpty(columnsSet)) {
        for (Columns eachColumns : columnsSet) {
          if (ToolUtil.isNotNullStr(primaryKey) && primaryKey.equals(eachColumns.getColumnsId())) {
            continue;
          ...
          columnConfigMap.put("initialLowercaseColumnName", eachColumns.getInitialLowercaseColumnName());
          columnConfigMap.put("columnNameAnnotation", eachColumns.getColumnNameAnnotation());
          vueListStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/list/5.txt"), columnConfigMap));
        }
      }
      vueListStr.delete(vueListStr.length() - 2, vueListStr.length()).append("\n");
      vueListStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/list/6.txt"), configMap));
      if (ToolUtil.isNotEmpty(querySet)) {
        for (Query eachQuery : querySet) {
          if ("AndKeyLike".equals(eachQuery.getQueryType()) || "OrKeyLike".equals(eachQuery.getQueryType())) {
            ...
            Columns columns = columnsPersistent.getColumnsByPk(eachQuery.getColumnsId());
            columnConfigMap.put("initialLowercaseColumnName", columns.getInitialLowercaseColumnName() + eachQuery.getQueryType());
            vueListStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/list/7.txt"), columnConfigMap));
          }
        }
      }
      vueListStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/list/8.txt"), configMap));
      StrTools.getFileFromContentStrAndPath(vueListStr.toString(), config.getVueListFilePath());
    } catch (CodePluginException e) {
      if (log.isErrorEnabled()) {
        log.error(e);
      }
  ...
  @Override
  public void codingVueListCss(String dtId, Config config) throws CodePluginException {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingService.codingVueListCss ");
      log.debug("parameter dtId is : " + dtId);
      log.debug("parameter config is : " + config);
    }
    try {
      ...
      StringBuilder vueListCssStr = new StringBuilder();
      LinkedHashMap<String, String> configMap = new LinkedHashMap<String, String>();
      configMap.putAll(ConfigTools.configMap);
      vueListCssStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/list/css/1.txt"), configMap));
      StrTools.getFileFromContentStrAndPath(vueListCssStr.toString(), config.getVueListCssFilePath());
    } catch (CodePluginException e) {
      if (log.isErrorEnabled()) {
        log.error(e);
      }
  ...
  @Override
  public void codingVueEdit(String dtId, Config config) throws CodePluginException {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingService.codingVueEdit ");
      log.debug("parameter dtId is : " + dtId);
      log.debug("parameter config is : " + config);
    }
    try {
      ...
      StringBuilder vueEditStr = new StringBuilder();
      LinkedHashMap<String, String> configMap = new LinkedHashMap<String, String>();
      Dt dt = dtPersistent.getDtByPk(dtId);
      ColumnsQuery columnsQuery = new ColumnsQuery();
      columnsQuery.setDtId(dt.getDtId());
      ...
      vueEditStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/edit/1.txt"), configMap));
      if (ToolUtil.isNotEmpty(columnsSet)) {
        for (Columns eachColumns : columnsSet) {
          if (ToolUtil.isNotNullStr(primaryKey) && primaryKey.equals(eachColumns.getColumnsId())) {
            continue;
          ...
          String dataType = SqlTools.getAngularDataTypeFromDtDataTypeStr(eachColumns.getDataType());
          if ("string".equals(dataType)) {
            vueEditStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/edit/2.txt"), columnConfigMap));
          } else if ("number".equals(dataType)) {
            vueEditStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/edit/3.txt"), columnConfigMap));
          }
        }
      }
      vueEditStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/edit/4.txt"), configMap));
      if (ToolUtil.isNotEmpty(columnsSet)) {
        for (Columns eachColumns : columnsSet) {
          if (ToolUtil.isNotNullStr(primaryKey) && primaryKey.equals(eachColumns.getColumnsId())) {
            continue;
          ...
          if ("n".equals(eachColumns.getIsNull())) {
            if ("string".equals(dataType)) {
              vueEditStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/edit/5.txt"), columnConfigMap));
            } else if ("number".equals(dataType)) {
              vueEditStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/edit/6.txt"), columnConfigMap));
            }
          }
        }
      }
      vueEditStr.delete(vueEditStr.length() - 2, vueEditStr.length()).append("\n");
      vueEditStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/edit/7.txt"), configMap));
      StrTools.getFileFromContentStrAndPath(vueEditStr.toString(), config.getVueEditFilePath());
    } catch (CodePluginException e) {
      if (log.isErrorEnabled()) {
        log.error(e);
      }
  ...
  @Override
  public void codingVueEditCss(String dtId, Config config) throws CodePluginException {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingService.codingVueEditCss ");
      log.debug("parameter dtId is : " + dtId);
      log.debug("parameter config is : " + config);
    }
    try {
      ...
      StringBuilder vueEditCssStr = new StringBuilder();
      LinkedHashMap<String, String> configMap = new LinkedHashMap<String, String>();
      configMap.putAll(ConfigTools.configMap);
      vueEditCssStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/edit/css/1.txt"), configMap));
      StrTools.getFileFromContentStrAndPath(vueEditCssStr.toString(), config.getVueEditCssFilePath());
    } catch (CodePluginException e) {
      if (log.isErrorEnabled()) {
        log.error(e);
      }
  ...
  @Override
  public void codingVueDetail(String dtId, Config config) throws CodePluginException {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingService.codingVueDetail ");
      log.debug("parameter dtId is : " + dtId);
      log.debug("parameter config is : " + config);
    }
    try {
      ...
      StringBuilder vueDetailStr = new StringBuilder();
      LinkedHashMap<String, String> configMap = new LinkedHashMap<String, String>();
      Dt dt = dtPersistent.getDtByPk(dtId);
      ColumnsQuery columnsQuery = new ColumnsQuery();
      columnsQuery.setDtId(dt.getDtId());
      ...
      vueDetailStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/detail/1.txt"), configMap));
      if (ToolUtil.isNotEmpty(columnsSet)) {
        for (Columns eachColumns : columnsSet) {
          LinkedHashMap<String, String> columnConfigMap = new LinkedHashMap<String, String>();
          columnConfigMap.putAll(configMap);
          columnConfigMap.put("initialLowercaseColumnName", eachColumns.getInitialLowercaseColumnName());
          columnConfigMap.put("columnNameAnnotation", eachColumns.getColumnNameAnnotation());
          vueDetailStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/detail/2.txt"), columnConfigMap));
        }
      }
      vueDetailStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/detail/3.txt"), configMap));
      StrTools.getFileFromContentStrAndPath(vueDetailStr.toString(), config.getVueDetailFilePath());
    } catch (CodePluginException e) {
      if (log.isErrorEnabled()) {
        log.error(e);
      }
  ...
  @Override
  public void codingVueDetailCss(String dtId, Config config) throws CodePluginException {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingService.codingVueDetailCss ");
      log.debug("parameter dtId is : " + dtId);
      log.debug("parameter config is : " + config);
    }
    try {
      ...
      StringBuilder vueDetailCssStr = new StringBuilder();
      LinkedHashMap<String, String> configMap = new LinkedHashMap<String, String>();
      configMap.putAll(ConfigTools.configMap);
      vueDetailCssStr.append(StrTools.renderString(StrTools.getStrFromFileResourcesPath("/vue/detail/css/1.txt"), configMap));
      StrTools.getFileFromContentStrAndPath(vueDetailCssStr.toString(), config.getVueDetailCssFilePath());
    } catch (CodePluginException e) {
      if (log.isErrorEnabled()) {
        log.error(e);
      }
