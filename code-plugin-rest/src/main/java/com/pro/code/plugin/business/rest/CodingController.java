package com.pro.code.plugin.business.rest;
...
public class CodingController extends ToolController {
  ...
  @javax.annotation.Resource(name = "com.pro.code.plugin.business.CodingService")
  ...
  public Responses<Config> codingAll(Parameter parameter, @RequestBody Config config) {
    ...
    try {
      ...
      codingService.codingServiceImpl(parameter.getPrimaryKey(), config);
      codingService.codingController(parameter.getPrimaryKey(), config);
      codingService.codingVo(parameter.getPrimaryKey(), config);
//      codingService.codingAngularModule(parameter.getPrimaryKey(), config);
//      codingService.codingAngularRouting(parameter.getPrimaryKey(), config);
//      codingService.codingAngularEntity(parameter.getPrimaryKey(), config);
//      codingService.codingAngularQuery(parameter.getPrimaryKey(), config);
...
//      codingService.codingAngularDetailHtml(parameter.getPrimaryKey(), config);
//      codingService.codingAngularDetailCss(parameter.getPrimaryKey(), config);
      codingService.codingVueEntity(parameter.getPrimaryKey(), config);
      codingService.codingVueQuery(parameter.getPrimaryKey(), config);
      codingService.codingVueVo(parameter.getPrimaryKey(), config);
      codingService.codingVueService(parameter.getPrimaryKey(), config);
      codingService.codingVueStore(parameter.getPrimaryKey(), config);
      codingService.codingVueList(parameter.getPrimaryKey(), config);
      codingService.codingVueListCss(parameter.getPrimaryKey(), config);
      codingService.codingVueEdit(parameter.getPrimaryKey(), config);
  ...
  @RequestMapping(value = { "coding_vo" }, method = { RequestMethod.POST })
  @ResponseBody
  public Responses<Config> codingVo(Parameter parameter, @RequestBody Config config) {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingController.codingVo ");
      log.debug("parameter parameter is : " + parameter);
      log.debug("parameter config is : " + config);
    }
    Responses<Config> responses = new Responses<>();
  ...
  @RequestMapping(value = { "coding_vue_entity" }, method = { RequestMethod.POST })
  @ResponseBody
  public Responses<Config> codingVueEntity(Parameter parameter, @RequestBody Config config) {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingController.codingVueEntity ");
      log.debug("parameter parameter is : " + parameter);
      log.debug("parameter config is : " + config);
    }
    Responses<Config> responses = new Responses<>();
  ...
  @RequestMapping(value = { "coding_vue_query" }, method = { RequestMethod.POST })
  @ResponseBody
  public Responses<Config> codingVueQuery(Parameter parameter, @RequestBody Config config) {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingController.codingVueQuery ");
      log.debug("parameter parameter is : " + parameter);
      log.debug("parameter config is : " + config);
    }
    Responses<Config> responses = new Responses<>();
  ...
  @RequestMapping(value = { "coding_vue_vo" }, method = { RequestMethod.POST })
  @ResponseBody
  public Responses<Config> codingVueVo(Parameter parameter, @RequestBody Config config) {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingController.codingVueVo ");
      log.debug("parameter parameter is : " + parameter);
      log.debug("parameter config is : " + config);
    }
    Responses<Config> responses = new Responses<>();
  ...
  @RequestMapping(value = { "coding_vue_service" }, method = { RequestMethod.POST })
  @ResponseBody
  public Responses<Config> codingVueService(Parameter parameter, @RequestBody Config config) {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingController.codingVueService ");
      log.debug("parameter parameter is : " + parameter);
      log.debug("parameter config is : " + config);
    }
    Responses<Config> responses = new Responses<>();
  ...
  @RequestMapping(value = { "coding_vue_store" }, method = { RequestMethod.POST })
  @ResponseBody
  public Responses<Config> codingVueStore(Parameter parameter, @RequestBody Config config) {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingController.codingVueStore ");
      log.debug("parameter parameter is : " + parameter);
      log.debug("parameter config is : " + config);
    }
    Responses<Config> responses = new Responses<>();
  ...
  @RequestMapping(value = { "coding_vue_list" }, method = { RequestMethod.POST })
  @ResponseBody
  public Responses<Config> codingVueList(Parameter parameter, @RequestBody Config config) {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingController.codingVueList ");
      log.debug("parameter parameter is : " + parameter);
      log.debug("parameter config is : " + config);
    }
    Responses<Config> responses = new Responses<>();
  ...
  @RequestMapping(value = { "coding_vue_list_css" }, method = { RequestMethod.POST })
  @ResponseBody
  public Responses<Config> codingVueListCss(Parameter parameter, @RequestBody Config config) {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingController.codingVueListCss ");
      log.debug("parameter parameter is : " + parameter);
      log.debug("parameter config is : " + config);
    }
    Responses<Config> responses = new Responses<>();
  ...
  @RequestMapping(value = { "coding_vue_edit" }, method = { RequestMethod.POST })
  @ResponseBody
  public Responses<Config> codingVueEdit(Parameter parameter, @RequestBody Config config) {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingController.codingVueEdit ");
      log.debug("parameter parameter is : " + parameter);
      log.debug("parameter config is : " + config);
    }
    Responses<Config> responses = new Responses<>();
  ...
  @RequestMapping(value = { "coding_vue_edit_css" }, method = { RequestMethod.POST })
  @ResponseBody
  public Responses<Config> codingVueEditCss(Parameter parameter, @RequestBody Config config) {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingController.codingVueEditCss ");
      log.debug("parameter parameter is : " + parameter);
      log.debug("parameter config is : " + config);
    }
    Responses<Config> responses = new Responses<>();
  ...
  @RequestMapping(value = { "coding_vue_detail" }, method = { RequestMethod.POST })
  @ResponseBody
  public Responses<Config> codingVueDetail(Parameter parameter, @RequestBody Config config) {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingController.codingVueDetail ");
      log.debug("parameter parameter is : " + parameter);
      log.debug("parameter config is : " + config);
    }
    Responses<Config> responses = new Responses<>();
  ...
  @RequestMapping(value = { "coding_vue_detail_css" }, method = { RequestMethod.POST })
  @ResponseBody
  public Responses<Config> codingVueDetailCss(Parameter parameter, @RequestBody Config config) {
    if (log.isDebugEnabled()) {
      log.debug("Staring call CodingController.codingVueDetailCss ");
      log.debug("parameter parameter is : " + parameter);
      log.debug("parameter config is : " + config);
    }
    Responses<Config> responses = new Responses<>();
